...
# Script to generate main.cpp with ArrayQueue test program
...
int main() {
    ...
    try {
        cout << "front: " << queueA.front() << " ";
    } catch (string& e) {
        cout << "front: error, queue is empty, cannot access the front ";
    }
    try {
        cout << "back: " << queueA.back() << " ";
    } catch (string& e) {
        cout << "back: error, queue is empty, cannot access the back ";
    }
